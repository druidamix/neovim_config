local opts = { noremap = true, silent = true, expr=true, replace_keycodes=true }
...
--keymap("i", "<TAB>", 'coc#pum#visible() ? coc#pum#confirm(1) : v:lua.check_back_space() ? "<TAB>" : coc#refresh()', opts)
